(function () {
     ...
     * @private
     */
    define('tinymce.plugins.glossary.Plugin', [
      'tinymce.core.Env',
        ...
        //   if (!selectedWords || options.length < 1) return;
          ...
          editor.windowManager.open({
            ...
            onSubmit: function (e) {
              ...
              var shortcode = `<span class="shortcode shortcode--glossary">[glossary ${params.join(
                ' '
              )}]${selectedWords}[/glossary]</span>`;
