(function () {
    ...
    /*jsc
    ["tinymce.plugins.glossary.Plugin","tinymce.core.Env","tinymce.core.PluginManager","global!tinymce.util.Tools.resolve"]
    jsc*/
    ...
    /**
     * This class contains all core logic for the glossary plugin.
     *
     * @class tinymce.glossary.Plugin
     * @private
     */
    define(
      'tinymce.plugins.glossary.Plugin',
      [
        'tinymce.core.Env',
        'tinymce.core.PluginManager'
      ],
      ...
      function (Env, PluginManager) {
        PluginManager.add('glossary', function (editor) {
          var options = window.glossaryTermOptions;
          ...
          // If an array with additional field config is provided add them to the dialog body
          if (window.glossaryTermsAdditionalFields) {
            var additionalFields = window.glossaryTermsAdditionalFields;
            if (additionalFields) {
          ...
          var showDialog = function () {
            ...
            editor.windowManager.open({
              title: 'Insert Term Definition from the Glossary',
              body: dialogBody,
              onsubmit: function (e) {
                var params = [];
                ...
                var shortcode = `<span class="shortcode shortcode--glossary">[glossary ${params.join(' ')}]${selectedWords}[/glossary]</span>`;
          ...
          var setupClickListener = function (editor) {
            editor.on('dblclick', function (e) {
              ...
              if (span && span.classList.contains('shortcode--glossary')) {
                editor.selection.select(span);
              }
            });
          };
    
          editor.addCommand('mceGlossary', showDialog);
    ...
    dem('tinymce.plugins.glossary.Plugin')();
})();